...
CREATE TABLE WE_ADD_FRIEND (
	...
	WE_USE_YN CHAR(1) COMMENT '사용여부'
) COMMENT = '관심인맥' DEFAULT character set utf8 collate utf8_general_ci;
...
) ENGINE = InnoDB COMMENT = '사용자액션알람' DEFAULT character set utf8 collate utf8_general_ci;
...
) COMMENT = '위키배너관리' DEFAULT character set utf8 collate utf8_general_ci;
...
CREATE TABLE WE_FAVORITE (
	...
	WE_ADD_DATE DATETIME COMMENT '추가일',
	WE_DEL_DATE DATETIME COMMENT '삭제일'
) COMMENT = '즐겨찾기' DEFAULT character set utf8 collate utf8_general_ci;
...
) ENGINE = InnoDB COMMENT = '첨부파일관리' DEFAULT character set utf8 collate utf8_general_ci;
...
) ENGINE = InnoDB COMMENT = '그룹정보' DEFAULT character set utf8 collate utf8_general_ci;
...
) COMMENT = '글라이더 라이센스 정보' DEFAULT character set utf8 collate utf8_general_ci;
...
) ENGINE = InnoDB COMMENT = '사이트로그' DEFAULT character set utf8 collate utf8_general_ci;
...
) ENGINE = InnoDB COMMENT = '위키메타정보' DEFAULT character set utf8 collate utf8_general_ci;
...
) ENGINE = InnoDB COMMENT = '메일전송내역' DEFAULT character set utf8 collate utf8_general_ci;
...
) ENGINE = InnoDB COMMENT = '공간참여신청' DEFAULT character set utf8 collate utf8_general_ci;
...
) ENGINE = InnoDB COMMENT = '템플릿정보' DEFAULT character set utf8 collate utf8_general_ci;
...
) ENGINE = InnoDB COMMENT = '회원기본' DEFAULT character set utf8 collate utf8_general_ci;
...
CREATE TABLE WE_USER_ALARM (
	...
	WE_INS_DATE DATETIME COMMENT '입력일',
	WE_INS_USER INT(13) COMMENT '입력자'
) ENGINE = InnoDB COMMENT = '사용자선택알람' DEFAULT character set utf8 collate utf8_general_ci;
...
) ENGINE = InnoDB COMMENT = '직위코드' DEFAULT character set utf8 collate utf8_general_ci;
...
CREATE TABLE WE_USER_POSITION (
	...
	WE_USER_IDX INT(13) COMMENT '회원순번 : 회원순번',
	PRIMARY KEY (WE_USER_POSITION_IDX)
) ENGINE = InnoDB COMMENT = '직급코드' DEFAULT character set utf8 collate utf8_general_ci;
...
) COMMENT = '위키기본정보' DEFAULT character set utf8 collate utf8_general_ci;
...
CREATE TABLE WE_WIKI_AGREE (
	...
	WE_USER_IDX INT(13) NOT NULL COMMENT '회원순번 : 회원순번',
	WE_WIKI_IDX INT(7) NOT NULL COMMENT '위키번호 : 위키번호'
) COMMENT = '위키공감사용자' DEFAULT character set utf8 collate utf8_general_ci;
...
) ENGINE = InnoDB COMMENT = '위키기본리비전정보' DEFAULT character set utf8 collate utf8_general_ci;


-- 위키 댓글 
CREATE TABLE WE_WIKI_COMMENT
(
	WE_WIKI_COMMENT_IDX INT(9) NOT NULL AUTO_INCREMENT COMMENT '위키댓글순번',
	WE_WIKI_IDX INT(7) NOT NULL COMMENT '위키번호',
	WE_BBS_TEXT TEXT character set utf8 collate utf8_general_ci COMMENT '게시판본문',
	WE_USER_IP VARCHAR(30) COMMENT '사용자아이피',
	WE_USE_YN CHAR(1) COMMENT '사용여부 : 사용여부',
	WE_INS_NAME VARCHAR(30) character set utf8 collate utf8_general_ci COMMENT '작성자 이름',
	WE_INS_DATE DATETIME COMMENT '입력일',
	WE_INS_USER INT(13) COMMENT '입력자',
...
) ENGINE = InnoDB COMMENT = '컨텐츠요약서머리' DEFAULT character set utf8 collate utf8_general_ci;
...
) ENGINE = InnoDB COMMENT = '위키태그' DEFAULT character set utf8 collate utf8_general_ci;
...
) COMMENT = '위키조회사용자' DEFAULT character set utf8 collate utf8_general_ci;
