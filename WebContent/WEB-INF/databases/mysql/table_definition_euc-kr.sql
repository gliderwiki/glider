...
) ENGINE = InnoDB COMMENT = '아이피접근제어' DEFAULT CHARACTER SET euckr COLLATE euckr_korean_ci; 
...
) COMMENT = '위키뉴스게시판' DEFAULT CHARACTER SET euckr COLLATE euckr_korean_ci; 
...
) COMMENT = '게시판 첨부파일 맵핑정보' DEFAULT CHARACTER SET euckr COLLATE euckr_korean_ci; 
...
) COMMENT = '게시판댓글정보' DEFAULT CHARACTER SET euckr COLLATE euckr_korean_ci; 
...
) ENGINE = InnoDB COMMENT = '그룹에속한사용자' DEFAULT CHARACTER SET euckr COLLATE euckr_korean_ci; 
...
) COMMENT = '위키마크업태그정보' DEFAULT CHARACTER SET euckr COLLATE euckr_korean_ci; 
...
) COMMENT = '메뉴관리' DEFAULT CHARACTER SET euckr COLLATE euckr_korean_ci; 
...
) ENGINE = InnoDB COMMENT = '사용자 프로필' DEFAULT CHARACTER SET euckr COLLATE euckr_korean_ci; 
...
) ENGINE = InnoDB COMMENT = '위키스페이스정보' DEFAULT CHARACTER SET euckr COLLATE euckr_korean_ci; 
...
CREATE TABLE WE_SPACE_GROUP (
	...
	WE_INS_DATE DATETIME NOT NULL COMMENT '입력일'
) ENGINE = InnoDB COMMENT = '공간접근가능그룹' DEFAULT CHARACTER SET euckr COLLATE euckr_korean_ci; 
...
) ENGINE = InnoDB COMMENT = '공간이미지정보관리' DEFAULT CHARACTER SET euckr COLLATE euckr_korean_ci; 
...
CREATE TABLE WE_SPACE_USER (
	...
	WE_USER_IDX INT(13) COMMENT '초대한회원아이디',
	WE_INS_DATE DATETIME NOT NULL COMMENT '입력일'
) ENGINE = InnoDB COMMENT = '접근허용회원' DEFAULT CHARACTER SET euckr COLLATE euckr_korean_ci; 
...
) COMMENT = '위키댓글정보' DEFAULT CHARACTER SET euckr COLLATE euckr_korean_ci; 
...
CREATE TABLE WE_WIKI_FILE (
	...
	WE_USE_YN CHAR(1) COMMENT '사용여부',
	PRIMARY KEY (WE_FILE_IDX)
) ENGINE = InnoDB COMMENT = '위키파일정보' DEFAULT CHARACTER SET euckr COLLATE euckr_korean_ci; 
...
) COMMENT = '위키차트' DEFAULT CHARACTER SET euckr COLLATE euckr_korean_ci; 
...
) ENGINE = InnoDB COMMENT = '위키링크' DEFAULT CHARACTER SET euckr COLLATE euckr_korean_ci; 
...
CREATE TABLE WE_WIKI_LOG (
	...
	WE_INS_DATE DATETIME NOT NULL COMMENT '입력일'
) ENGINE = InnoDB COMMENT = '위키작성로그' DEFAULT CHARACTER SET euckr COLLATE euckr_korean_ci; 
...
) ENGINE = InnoDB COMMENT = '위키각주정보' DEFAULT CHARACTER SET euckr COLLATE euckr_korean_ci; 
...
) COMMENT = '설치사용자정보' DEFAULT CHARACTER SET euckr COLLATE euckr_korean_ci; 
...
) COMMENT = '위키기능리스트' DEFAULT CHARACTER SET euckr COLLATE euckr_korean_ci; 
...
) COMMENT = '패치대상파일목록' DEFAULT CHARACTER SET euckr COLLATE euckr_korean_ci; 
