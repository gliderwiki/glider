...
CREATE TABLE WE_MARKUP_TAG (
	...
	WE_MARK_DESC VARCHAR(200) COMMENT '태그설명',
...
) ENGINE = InnoDB COMMENT = '위키메타정보 : 위키메타정보 위키 알람 이벤트시 메타 정보를 기준으로 보내기 때문에 기준 업무별로 미리 정' DEFAULT CHARACTER SET utf8;
...
CREATE TABLE WE_SPACE (
	...
	WE_SPACE_DESC VARCHAR(800) COMMENT '위키스페이스설명',		
...
CREATE TABLE WE_TEMPLATE (
	...
	WE_TEMPLATE_NAME VARCHAR(100) COMMENT '템플릿명',
	WE_USE_YN CHAR(1) COMMENT '사용여부',
	WE_INS_USER INT(13) COMMENT '입력자',
	WE_INS_DATE DATETIME COMMENT '입력일',
	WE_UPD_USER INT(13) COMMENT '수정자',
...
CREATE TABLE WE_WIKI_TAG (
	...
	WE_WIKI_IDX INT(7) NOT NULL COMMENT '위키번호 : 위키번호',
	WE_TAG VARCHAR(30) COMMENT '태그명',
	WE_WIKI_REVISION INT(3) NOT NULL COMMENT '현재위키버전정보 : 현재위키버전정보',
	WE_INS_DATE DATETIME NOT NULL COMMENT '입력일',
	WE_USE_YN CHAR(1) NOT NULL COMMENT '사용여부',
	PRIMARY KEY (WE_WIKI_TAG_IDX)
) ENGINE = InnoDB COMMENT = '위키태그 : 위키 태그를 저장한다.' DEFAULT CHARACTER SET utf8;
...
(
	...
	WE_DOMAIN VARCHAR(100) COMMENT '사용자도메인 : 사용자도메인',
...
(
	...
	WE_FUNCTION_DESC VARCHAR(400) COMMENT '기능설명',
...
) COMMENT = '위키기능리스트' DEFAULT CHARACTER SET utf8;
...
(
	...
	WE_FILE_NAME VARCHAR(40) COMMENT '파일명 : 파일명',
	WE_FILE_PATH VARCHAR(200) COMMENT '파일경로',
...
) COMMENT = '패치대상파일목록' DEFAULT CHARACTER SET utf8;
