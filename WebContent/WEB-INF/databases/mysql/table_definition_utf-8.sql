...
CREATE TABLE WE_ADD_FRIEND (
	...
	WE_USE_YN CHAR(1) COMMENT '사용여부'
) COMMENT = '관심인맥' DEFAULT CHARACTER SET utf8; 
...
) ENGINE = InnoDB COMMENT = '사용자액션알람' DEFAULT CHARACTER SET utf8;
...
) COMMENT = '위키배너관리' DEFAULT CHARACTER SET utf8;
...
CREATE TABLE WE_FAVORITE (
	...
	WE_ADD_DATE DATETIME COMMENT '추가일',
	WE_DEL_DATE DATETIME COMMENT '삭제일'
) COMMENT = '즐겨찾기' DEFAULT CHARACTER SET utf8;
...
) ENGINE = InnoDB COMMENT = '첨부파일관리' DEFAULT CHARACTER SET utf8;
...
) ENGINE = InnoDB COMMENT = '그룹정보' DEFAULT CHARACTER SET utf8;
...
) COMMENT = '글라이더 라이센스 정보' DEFAULT CHARACTER SET utf8;
...
) ENGINE = InnoDB COMMENT = '사이트로그' DEFAULT CHARACTER SET utf8;
...
) ENGINE = InnoDB COMMENT = '위키메타정보' DEFAULT CHARACTER SET utf8;
...
) ENGINE = InnoDB COMMENT = '메일전송내역' DEFAULT CHARACTER SET utf8;
...
) ENGINE = InnoDB COMMENT = '공간참여신청' DEFAULT CHARACTER SET utf8;
...
) ENGINE = InnoDB COMMENT = '템플릿정보' DEFAULT CHARACTER SET utf8;
...
) ENGINE = InnoDB COMMENT = '회원기본' DEFAULT CHARACTER SET utf8;
...
CREATE TABLE WE_USER_ALARM (
	...
	WE_INS_DATE DATETIME COMMENT '입력일',
	WE_INS_USER INT(13) COMMENT '입력자'
) ENGINE = InnoDB COMMENT = '사용자선택알람' DEFAULT CHARACTER SET utf8;
...
) ENGINE = InnoDB COMMENT = '직위코드' DEFAULT CHARACTER SET utf8;
...
CREATE TABLE WE_USER_POSITION (
	...
	WE_USER_IDX INT(13) COMMENT '회원순번 : 회원순번',
	PRIMARY KEY (WE_USER_POSITION_IDX)
) ENGINE = InnoDB COMMENT = '직급코드' DEFAULT CHARACTER SET utf8;
...
) COMMENT = '위키기본정보' DEFAULT CHARACTER SET utf8;
...
CREATE TABLE WE_WIKI_AGREE (
	...
	WE_USER_IDX INT(13) NOT NULL COMMENT '회원순번 : 회원순번',
	WE_WIKI_IDX INT(7) NOT NULL COMMENT '위키번호 : 위키번호'
) COMMENT = '위키공감사용자' DEFAULT CHARACTER SET utf8;
...
) ENGINE = InnoDB COMMENT = '위키기본리비전정보' DEFAULT CHARACTER SET utf8;
...
) ENGINE = InnoDB COMMENT = '컨텐츠요약서머리' DEFAULT CHARACTER SET utf8;
...
) ENGINE = InnoDB COMMENT = '위키태그' DEFAULT CHARACTER SET utf8;
...
) COMMENT = '위키조회사용자' DEFAULT CHARACTER SET utf8;
